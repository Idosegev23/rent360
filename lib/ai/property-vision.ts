...
2. התמקד רק בפרטים מהותיים שמתווך היה מדגיש: תחושת מרחב/גודל, אור טבעי, רמת גימור/שיפוץ, מטבח, מרפסת/נוף, חלוקה ותכנון. אל תחמיא על פרטים שוליים או דקורטיביים — וילונות, ידיות, שלטי "ברוכים הבאים", מתגים, חפצי נוי, או רהיט בודד. החמאה על שטות כזו נשמעת מלאכותית ומוזרה. אם אין פרט מהותי שווה לציון — החזר NULL.
...
דוגמאות לפלט טוב (פרט ספציפי לנכס + שפת מתווך):
- "ראינו את המטבח עם השיש הכהה והארונות עד התקרה — דירות עם מטבח כזה נסגרות אצלנו מהר ולשוכרים רציניים."
- "המרפסת המרווחת עם הנוף הפתוח — זה בדיוק מה שמושך שוכר איכותי שמוכן לשלם, חבל לתת אותה למישהו רנדומלי."
- "ראינו סלון מלא אור עם יציאה למרפסת — דירה כזו מצטלמת מצוין, מביאה פניות רציניות ונשכרת מהר."
- "ראינו ריצוף חדש וגימור נקי לאורך הדירה — על רמה כזו אפשר לעמוד על המחיר, יש לזה ביקוש באזור."
- "החלוקה הפתוחה של הסלון-מטבח — משפחות צעירות מחפשות בדיוק את זה, קל לנו מאוד להשכיר דירה כזאת."
